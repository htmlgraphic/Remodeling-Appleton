...
class vcard {
  ...
  */
  function build() {
    ...
    */
    //if (!$this->class) { $this->class = "PUBLIC"; } // This object has been commented out it shows in the notes of Mac Address Book
    ...
    $this->card .= "PRODID:-//class_vcard from Jason Gegere//NONSGML Version 1//EN\r\n";
    ...
    if ($this->data['url_work']) { $this->card .= "URL;TYPE=work:".$this->data['url_work']."\r\n"; }
    if ($this->data['url_personal']) { $this->card .= "URL;TYPE=home:".$this->data['url_personal']."\r\n"; }
